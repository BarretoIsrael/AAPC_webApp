...
namespace AAPC.Controllers
{
    public class TreinosController : Controller
    {
        ...
        public TreinosController(MvcAAPCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Dia,Horario,Local")] Treino treino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Dia,Horario,Local")] Treino treino)
        {
            if (id != treino.Id)
            {
                return NotFound();
